                    ...
                    <Container fluid>
                           <Card.Subtitle><b>Contact Information:</b></Card.Subtitle>
                            ...
                            <Row>
                                ...
                                <Col lg = {10}><div className = "text-secondary">Super Visor</div></Col>
                            </Row>
                            <Row>
                                <Col lg = {2} style={{ color: "purple"}}>Email: </Col>
                                <Col lg = {10} ><div className = "text-secondary">supervisor@company.com</div></Col>
                            </Row>
                            <br/>
                            ...
                            <Row>
                                ...
                                <Col lg = {10}><div className = "text-secondary">Senior Software Engineer</div></Col>
                            </Row>
                            <Row>
                                <Col lg = {2} style={{ color: "purple"}}>Graduated from: </Col>
                                <Col lg = {10}><div className = "text-secondary">ODTÜ</div></Col>
                            </Row>
                            <Row>
                                <Col lg = {2} style={{ color: "purple"}}>University Major: </Col>
                                <Col lg = {10}><div className = "text-secondary">Computer Science</div></Col>
                            </Row>
                    </Container>
                </Card.Body>
            </Card>
