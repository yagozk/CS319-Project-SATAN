                    ...
                    <Card.Body>
                        ...
                        <Container fluid>
                                <Row>
                                    ...
                                    <Col lg = {10}><div className = "text-secondary">Osman Osmanovski</div></Col>
                                </Row>
                                <hr/>
                                <Row>
                                    <Col lg = {2} style={{ color: "purple"}}>Email: </Col>
                                    <Col lg = {10} ><div className = "text-secondary">osmanovski@bilkent.edu.tr</div></Col>
                                </Row>
                        </Container>
                    </Card.Body>
                </Card>
                ...
                <Card>
                    <Card.Body>
                        ...
                        <Container fluid>
                                <Row>
                                    <Col lg = {2} style={{ color: "purple"}}>Name: </Col>
                                    <Col lg = {10}><div className = "text-secondary">Feridun Feridun</div></Col>
                                </Row>
                                <hr/>
                                <Row>
                                    <Col lg = {2} style={{ color: "purple"}}>Email: </Col>
                                    <Col lg = {10} ><div className = "text-secondary">feridun@bilkent.edu.tr</div></Col>
                                </Row>
                        </Container>
                    </Card.Body>
                </Card>
